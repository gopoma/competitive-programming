...
void solve() {
    ...
    int groups136 = min({cnt[1], cnt[3], cnt[6]});
    int groups124 = min({cnt[1], cnt[2], cnt[4]});
    ...
    int groups126 = min({cnt[1], cnt[2], cnt[6]});
    cnt[1] -= groups126;
    cnt[2] -= groups126;
    cnt[6] -= groups126;
    ...
    if(ok) {
        for(int i = 0; i < groups136; i++) cout << "1 3 6\n";
        for(int i = 0; i < groups124; i++) cout << "1 2 4\n";
        for(int i = 0; i < groups126; i++) cout << "1 2 6\n";
    } else {
        cout << "-1\n";
    }
}
