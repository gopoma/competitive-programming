    ...
    while(true) {
        ...
        if(take >= 2) {
            if(iter & 1) {
                if(todo.ft == a.ft) {
                    int i = 0;
                    while(i + 1 < take && mp[todo[i].s] + 1 == mp[todo[i + 1].s]) {
                        i++;
                    }
                    int L = 0;
                    int R = i;
                ...
                if(todo.bk == a.bk) {
                    int i = take - 1;
                    while(i - 1 >= 0 && mp[todo[i].s] - 1 == mp[todo[i - 1].s]) {
                        i--;
                    }
                    int L = i;
                    int R = take - 1;
