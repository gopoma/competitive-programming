...
BIT<ll, 18, 18, 18, 18, 18> st;

void solve() {
    def(int, n1, n2, n3, n4, n5);
    dbg(n1, n2, n3, n4, n5);
    ...
    dbg(q);
    rep(q) {
        def(int, l1, l2, l3, l4, l5, r1, r2, r3, r4, r5);
        //? dbg(l1, l2, l3, l4, l5, r1, r2, r3, r4, r5);

        ll ans = st.query(l1, r1, l2, r2, l3, r3, l4, r4, l5, r5);
        dbg(ans);
        ps(ans);
    }
}
