...
void interpret(char c) {
    DBG(c);
    if(c == '0')      cout << "O-|-OOOO\n"; //! ok
    else if(c == '1') cout << "O-|O-OOO\n";
    else if(c == '2') cout << "O-|OO-OO\n";
    else if(c == '3') cout << "O-|OOO-O\n";
    else if(c == '4') cout << "O-|OOOO-\n";
    else if(c == '5') cout << "-O|-OOOO\n";
    else if(c == '6') cout << "-O|O-OOO\n";
    else if(c == '7') cout << "-O|OO-OO\n";
    else if(c == '8') cout << "-O|OOO-O\n";
    else if(c == '9') cout << "-O|OOOO-\n";
    else assert(false);
}
