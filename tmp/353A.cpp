...
void solve() {
    ...
    int fix = 0, left = 0, right = 0;
    for(auto& e: a) {
        if(e.first % 2 == 1 && e.second % 2 == 1) {
            fix++;
        } else if(e.first % 2 == 1) {
            left++;
    ...
    if(fix % 2 == 0) {
        if(((left + right) % 2) != 0) {
            ...
            // left and right should be divisible by 2
            if(left % 2 == 0 && right % 2 == 0) cout << "0\n";
            else cout << "1\n";
        }
    } else {
        if((left + right >= 2) && ((left + right) % 2 == 0)) {
            // left and right shouldn't be divisible by 2
            if(left % 2 != 0 && right % 2 != 0) cout << "0\n";
            else cout << "1\n";
        } else cout << "-1\n";
    }
