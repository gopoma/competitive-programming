...
void solve() {
    ...
    assert(!(x1 == x2 && y1 == y2));
    if(x1 == x2) {
        cout << (x1 + distance) << " " << y1 << " " << (x2 + distance) << " " << y2 << n_l;
    } else if(y1 == y2) {
        cout << x1 << " " << (y1 + distance) << " " << x2 << " " << (y2 + distance) << n_l;
    } else {
        int x3 = x1;
        int y3 = y2;
        int x4 = x2;
        ...
        if(((abs(x3 - x1) + abs(y3 - y1)) == (abs(x3 - x2) + abs(y3 - y2))) && ((abs(x4 - x1) + abs(y4 - y1)) == (abs(x4 - x2) + abs(y4 - y2)))) {
            cout << x3 << " " << y3 << " " << x4 << " " << y4 << n_l;
        } else {
            cout << "-1\n";
        }
    }
