...
void solve() {
    //? 1 2 3 4 5 6 7 8 9  -> 9    nums
    //? 10 11 12 ... 99    -> 90   nums
    //? 100 101 ... 999    -> 900  nums
    //? 1000 1001 ... 9999 -> 9000 nums
    //!                          digits
    //! 1-digit: 10^0 -> 9    -> 9 * 10^0 * 1
    //! 2-digit: 10^1 -> 90   -> 9 * 10^1 * 2
    //! 3-digit: 10^2 -> 900  -> 9 * 10^2 * 3
    //! 4-digit: 10^3 -> 9000 -> 9 * 10^3 * 4
    //! x-digit: 10^(x-1)     -> 9 * 10^(x-1) * (x-1)
    ...
    auto get = [&](ll x) {
        ll dleft = 0; //? # digits of nums with fewer digits
        ll dright = 0; //? # of nums with equal digits but less than
        for(ll i = 0; i < cnt(x) - 1; i++) {
            dleft += 9LL * binpow(10LL, i) * (i + 1);
            dright += 9LL * binpow(10LL, i);
        }

        ll dcount = dleft;
        dcount += cnt(x) * (x - dright - 1);
