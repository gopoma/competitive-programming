...
void solve() {
    ...
    ll lower_bound = ll(-2e9);
    ll upper_bound = ll(2e9);
    while(n--) {
        str sign; ll x; char answer;
        cin >> sign >> x >> answer;

        if(answer == 'Y') {
            if(sign == ">") {
                ckmax(lower_bound, x + 1);
            } else if(sign == "<") {
                ckmin(upper_bound, x - 1);
            } else if(sign == ">=") {
                ckmax(lower_bound, x);
            } else if(sign == "<=") {
                ckmin(upper_bound, x);
    ...
    if(lower_bound <= upper_bound) cout << lower_bound;
