...
void solve() {
    ...
    int n, m, q; cin >> n >> m >> q;
    vpi edges(m); for(auto& [u, v]: edges) cin >> u >> v;
    vpi que(q);   for(auto& [a, b]: que)   cin >> a >> b;
