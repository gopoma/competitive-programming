...
#ifdef LOCAL
    #include "helpers/debug_blindness.h"
#else
    #define dbg(...)     0
    #define chk(...)     0
...
void solve() {
    ...
    tuple<int, string, int> c = make_tuple(1, "Diego Huamani", 3);
    dbg(c);
    V<tuple<int, char, int, int>> l;
    l.eb(make_tuple(1, 'f', 3, 4));
    l.eb(make_tuple(5, '6', 7, 8));
    l.eb(make_tuple(9, 'x', 11, -12));
    dbg(l);

    set<tuple<int, int, int, int>> o;
    o.emplace(make_tuple(1, 2, 3, 4));
    o.emplace(make_tuple(5, 1, 7, 8));
    o.emplace(make_tuple(9, 1, 11, -12));
    o.emplace(make_tuple(1, 2, 3, 4));
    o.emplace(make_tuple(5, 1, 7, 9));
    o.emplace(make_tuple(1, 2, 3, 4));
    ...
    vs r = {
        "Diego Huamani Luque",
        "Diego Pacori Anccasi"
    };

    V<set<int>> u;
    set<int> u1; u1.emplace(3); u1.emplace(3); u1.emplace(4);
    u.eb(u1);
    dbg(o, p, r, u);
