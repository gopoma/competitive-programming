...
ll brute(ll a, ll b, ll r) {
    //? work with x from 0 to r -> 0 <= x <= r
    ll mn = BIG;
    for(ll x = 0; x <= r; x++) {
        ll val = abs((a ^ x) - (b ^ x));
        ckmin(mn, val);
...
void solve() {
    ...
    auto work = [&](const ll x, const ll y) {
        ll x1 = x, y1 = y;

        ll go = r;
        for(ll i = 63LL; i >= 0LL; i--) {
            if(((x1 & (1LL << i)) == (1LL << i)) && ((y1 & (1LL << i)) == 0LL)) {
                if((1LL << i) <= go) {
                    go -= (1LL << i);
                    x1 -= (1LL << i);
                    y1 += (1LL << i);
        ...
        for(ll i = 63LL; i >= 0LL; i--) {
            if(((x2 & (1LL << i)) == 0LL) && (((y2 & (1LL << i)) == (1LL << i)))) {
                if((1LL << i) <= go) {
                    go -= (1LL << i);
                    x2 += (1LL << i);
                    y2 -= (1LL << i);
        ...
        bool passed1 = false;
        for(ll i = 63LL; i >= 0LL; i--) {
            if(((x3 & (1LL << i)) == (1LL << i)) && ((y3 & (1LL << i)) == 0LL)) {
                if((1LL << i) <= go) {
                    if(!passed1) { passed1 = true; continue; }
                    go -= (1LL << i);
                    x3 -= (1LL << i);
                    y3 += (1LL << i);
                }
        ...
        for(ll i = 63LL; i >= 0LL; i--) {
            if(((x4 & (1LL << i)) == 0LL) && (((y4 & (1LL << i)) == (1LL << i)))) {
                if((1LL << i) <= go) {
                    if(!passed2) { passed2 = true; continue; }
                    go -= (1LL << i);
                    x4 += (1LL << i);
                    y4 -= (1LL << i);
                }
        ...
        return min({abs(x1 - y1), abs(x2 - y2), abs(x3 - y3), abs(x4 - y4)});
    };
