...
void solve() {
    ...
    vector<long long> memo(l + 5, 0LL);
    vector<bool> vis(l + 5, false);
    // solve(x): maximum revenue from selling a rod of length 'x'
...
signed main() {
    // https://codeforces.com/group/OyefIGO3t4/contest/447266/problem/E
    // E. Rod Cutting
