...
void solve() {
    ...
    auto work = [&](ll xx) {
        if(xx == 0) return Z(0LL);

        Z res = Z(0);
        ll last = 63LL - __builtin_clzll(xx);
        Z nxtOdd = Z(1);
        Z nxtEven = Z(2);
        ...
        for(ll i = 0; i < last; i++) {
            Z give = power(Z(2LL), i);
            if(i % 2 == 0) {
                // odds
                res += (give * (nxtOdd + nxtOdd + Z(2LL) * (give - Z(1LL)))) / Z(2LL);
                nxtOdd += Z(2LL) * give;
            } else {
                // evens
                res += (give * (nxtEven + nxtEven + Z(2LL) * (give - Z(1LL)))) / Z(2LL);
                nxtEven += Z(2LL) * give;
            }
        }
        ...
        Z use = (last % 2 == 0)? nxtOdd : nxtEven;
        res += (x * (use + use + Z(2) * (x - Z(1LL)))) / Z(2LL);
