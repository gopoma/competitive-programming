...
void solve() {
    ...
    //? DD.MM.YYYY
    auto work1 = [&](Date d) {
        str result = norm(d.day, 2) + "." + norm(d.month, 2) + "." + norm(d.year, 4);
        return result;
    };

    //? MM/DD/YYYY
    auto work2 = [&](Date d) {
        str result = norm(d.month, 2) + "/" + norm(d.day, 2) + "/" + norm(d.year, 4);
        return result;
    };
